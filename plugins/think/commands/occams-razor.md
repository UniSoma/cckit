...
Among competing explanations, prefer the one with fewest assumptions. Simplest does not mean easiest; simplest means fewest moving parts.
</objective>
...
- Does not oversimplify (must fit ALL facts)
